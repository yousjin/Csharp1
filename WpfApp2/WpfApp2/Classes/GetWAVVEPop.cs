                ...
                for (int j = 0; j < pages; j++)
                {
                    for (int i = 0; i < Count_per_page; i++)
                    {
                        ...
                        if (conElement.Displayed)
                        {
                            ...
                            MessageBox.Show(WAVVEdata[i + Count_per_page * j].ConInfo);
                            ...
                            MessageBox.Show(WAVVEdata[i + Count_per_page * j].Name);

                            WAVVEdata[i + j * Count_per_page].ConPlot = contentPlotResult;
                            MessageBox.Show(WAVVEdata[i + Count_per_page * j].ConPlot);
